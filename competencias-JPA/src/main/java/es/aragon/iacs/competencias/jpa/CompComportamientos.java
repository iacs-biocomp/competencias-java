...
@NamedQueries({
	@NamedQuery(name="CompComportamientos.findAll", query="SELECT c FROM CompComportamientos c"),
	@NamedQuery(name="CompComportamientos.findById", query="SELECT c FROM CompComportamientos c WHERE c.id=:id"),
	@NamedQuery(name="CompComportamientos.findActivos", query="SELECT c FROM CompComportamientos c WHERE c.baja=null OR c.baja='' OR c.baja>=:fechaHoy")
})
