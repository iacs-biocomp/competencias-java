...
//    private CompCatCompetenciales catCompetencial;
    ...
    public String borrarRelacion() {
    	log.debug("Aqui estar�a eliminando la relaci�n con id: " + idRelacion+" codCompetencia "+ codCompetencia+ " codCatComp "+ catCompetencial);
    	...
    	if(eliminada) {
        	...
        	log.debug("Se ha eliminado la relaci�n con id: " + idRelacion);
    	}
    ...
    public String nuevaRelacion() {
    	log.debug("Se va a a�adir relacion entre competencia con codigo: "+codigo+ " codCatCompetencial: " + codCatCompetencial+ " idNivel: "+ idNivel);
    	competenciasDao.insertRelacion(codigo,codCatCompetencial,idNivel);
    	log.debug("Se ha a�adido relacion entre competencia con codigo: "+codigo+ " codCatCompetencial: " + codCatCompetencial+ " idNivel: "+ idNivel);
...
//    
    public String nuevaRelacionComportamientos() {
    	log.debug("Se va a a�adir relacionComportamiento entre competencia con codigo: "+codComp+ " codCatCompetencial: " + codCatComp+ " idNivel: "+ idNivel+ " comportamiento: "+ idComportamiento);
    	competenciasDao.insertRelacionComportamientos(codComp,codCatComp,idNivel,idComportamiento);
    	log.debug("Se ha a�adido relacionComportamiento entre competencia con codigo: "+codComp+ " codCatCompetencial: " + codCatComp+ " idNivel: "+ idNivel+ " comportamiento: "+ idComportamiento);
