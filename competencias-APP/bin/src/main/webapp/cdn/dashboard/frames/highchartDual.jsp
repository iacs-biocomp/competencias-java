<!--  Frame to include dual highcharts graphics + leaflet maps
	  Div for graphics has name hc_{frame_id} and height=400px
	  Div for map has name map_{frame_id} and height=400px
-->
...
<!-- 							<li><a data-rel="collapse" href="#"><i class="icon-down-open"></i></a></li>
					...
					<div class="panel-body" id="map_{frame_id}" style="height: 400px; margin: 0 auto;"></div>
